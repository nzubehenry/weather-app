...
function fetchWeatherData(input) {
    /*Fetch the data and dynamically add the city name with template
    literals */
    fetch(`http://api.weatherapi.com/
        v1/current.json?key=bd768775fdbe4edfbef05238240708=${input}`)
        /*Take the data (whis is in JSON format
        and convert it to a regular is object */
    ...
    .then(data => {
        ...
        const code = data.current.condtion.code;
